...
import com.example.androidtutorial.databinding.ActivityPaywallBottomSheetDialogBinding
...
class PaywallBottomSheetDialog : BottomSheetDialogFragment() {
    ...
    private fun setupFixedBottomSheetBehavior(behavior: BottomSheetBehavior<*>) {
        behavior.apply {
            ...
            this.isFitToContents = true // Quan trọng: fit to content height
    ...
    private fun setupClickListeners() {
        binding.idClose.setOnClickListener { dismiss() }
